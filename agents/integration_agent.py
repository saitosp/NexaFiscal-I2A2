...
class IntegrationAgent:
    ...
    def get_nfe_distribution_service_url(
        self, uf: str, environment: str = "homologation"
    ) -> str:
        """
    ...
    def consultar_nfe_destinadas(
        ...
        try:
            ...
            cert_pem, key_pem = self.sefaz_service.get_certificate_data(
            ...
            try:
                ...
                # Cliente SOAP
                Client(wsdl_url, transport=transport)
    ...
    def manifestar_ciencia(
        ...
        return {
            "success": False,
            "message": "Funcionalidade em desenvolvimento. Manifestação do Destinatário requer assinatura digital XML.",
            "protocol": None,
            "info": {
                "chave_nfe": chave_nfe,
    ...
    def download_nfe_xml(
        ...
        return {
            ...
            "xml_content": None,
            "file_path": None,
            "info": {"chave_nfe": chave_nfe, "environment": environment},
        }

    def get_integration_status(
        self, credential_id: int, password: str
    ) -> Dict[str, Any]:
        """
